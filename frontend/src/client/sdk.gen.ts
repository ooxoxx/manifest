...
export class DatasetsService {
     ...
     * @param data The data for the request.
     * @param data.requestBody
     * @returns ClassStatsResponse Successful Response
     * @throws ApiError
     */
    public static filterClassStats(data: DatasetsFilterClassStatsData): CancelablePromise<DatasetsFilterClassStatsResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/datasets/filter-class-stats',
            body: data.requestBody,
            mediaType: 'application/json',
            errors: {
                422: 'Validation Error'
     ...
     * @throws ApiError
     */
    public static getDatasetClassStats(data: DatasetsGetDatasetClassStatsData): CancelablePromise<DatasetsGetDatasetClassStatsResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/datasets/{id}/class-stats',
            path: {
                id: data.id
            },
            errors: {
...
export class MinioInstancesService {
     ...
     * @param data.bucket
     * @param data.prefix
     * @returns BucketObjectsResponse Successful Response
     * @throws ApiError
     */
    public static listBucketObjects(data: MinioInstancesListBucketObjectsData): CancelablePromise<MinioInstancesListBucketObjectsResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/minio-instances/{id}/buckets/{bucket}/objects',
            path: {
                id: data.id,
                bucket: data.bucket
            },
...
export class SamplesService {
     ...
     * @param data The data for the request.
     * @param data.requestBody
     * @returns SampleThumbnail Successful Response
     * @throws ApiError
     */
    public static getSampleThumbnails(data: SamplesGetSampleThumbnailsData): CancelablePromise<SamplesGetSampleThumbnailsResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/samples/thumbnails',
            body: data.requestBody,
            mediaType: 'application/json',
            errors: {
                422: 'Validation Error'
...
export class TaggingRulesService {
     ...
     * @param data.skip
     * @param data.limit
     * @returns MappingPreviewResult Successful Response
     * @throws ApiError
     */
    public static previewMappingEndpoint(data: TaggingRulesPreviewMappingEndpointData): CancelablePromise<TaggingRulesPreviewMappingEndpointResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/tagging-rules/preview-mapping',
            query: {
                skip: data.skip,
                limit: data.limit
            },
     ...
     * @throws ApiError
     */
    public static createMappingRule(data: TaggingRulesCreateMappingRuleData): CancelablePromise<TaggingRulesCreateMappingRuleResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/tagging-rules/mapping',
            query: {
                execute_immediately: data.executeImmediately
            },
            body: data.requestBody,
...
export class TagsService {
     ...
     * @throws ApiError
     */
    public static getTagsByCategory(): CancelablePromise<TagsGetTagsByCategoryResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/tags/by-category'
        });
    }
